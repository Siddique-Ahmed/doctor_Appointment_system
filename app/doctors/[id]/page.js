...
export default function DoctorDetail({ params }) {
  ...
  console.log("Filter Doctor Data=>", doctorInfo);
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex items-center justify-between my-3">
                <h1 className="md:text-[17px] font-bold">Fees</h1>
                <h1 className="md:text-[17px] font-semibold">${doctorInfo.fees}</h1>
              </div>
              <div className="flex items-center justify-between my-3">
                <h1 className="md:text-[17px] font-bold">Appointment Time</h1>
                <h1 className="md:text-[17px] font-semibold">{doctorInfo.appointmentTime}</h1>
              </div>
              <div className="flex items-center justify-between my-3">
                <h1 className="md:text-[17px] font-bold">Hospital</h1>
                <h1 className="md:text-[17px] font-semibold">{doctorInfo.hospital}</h1>
              </div>
              <div className="flex items-center justify-between my-3">
